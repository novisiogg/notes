...
## 💻 Phase 12: How Computers Really Work — From Silicon to Software

*Focus: The journey from transistors to running programs. Learn what the CPU actually does, how memory is managed, what happens when you run a binary, and how the OS coordinates everything.*

### 12.1 From Transistors to Logic Gates
...
### 12.2 CPU Architecture in Depth
...
### 12.3 Assembly Language — Reading the Machine
...
### 12.4 How Compiling Works — From Code to Binary
...
### 12.5 Processes, Memory, and the OS Kernel
...
### 12.6 Compiled vs. Interpreted Languages — The Full Picture
...
## 🔐 Phase 13: Computer Security — Offense, Defense, and Everything Between
...
### 13.1 Security Mindset & Foundations
...
### 13.2 Cryptography — The Engine of Security
...
### 13.3 Web Security — How the Web Gets Hacked
...
### 13.4 Social Engineering & Phishing — The Human Attack Surface
...
### 13.5 Binary Exploitation & Memory Corruption
...
### 13.6 Linux Privilege Escalation
...
### 13.8 Reverse Engineering & Malware Analysis
...
### 13.9 Capture The Flag (CTF) Methodology
...
## 🌍 Phase 14: Networking — Deep Dive

*Focus: Understand networking from the physical signal to application-layer protocols. Know exactly what happens when a packet travels from your machine to a server in another country and back.*

### 14.1 Physical & Data Link Layer (OSI Layers 1–2)
...
### 14.3 Transport Layer — TCP & UDP (OSI Layer 4)
...
### 14.4 DNS — The Internet's Phone Book
...
### 14.5 Application Layer Protocols (OSI Layer 7)
...
### 14.6 Network Architecture & Design
...
### 14.7 Network Monitoring & Troubleshooting
...
* **Books**: "Artificial Intelligence: A Modern Approach" (Russell & Norvig); "Deep Learning" (Goodfellow); "Computer Systems: A Programmer's Perspective" (Bryant & O'Hallaron — the bible for Phase 12); "The Web Application Hacker's Handbook"; "Hacking: The Art of Exploitation" (Erickson).
...
## 💻 Phase 12: How Computers Really Work
...
### 13.4 · Social Engineering & Phishing
...
### 14.5 · Application Layer Protocols
...
### 14.6 · Network Architecture & Defense
- **Firewall & DMZ Lab**
...
### 14.7 · Monitoring & Troubleshooting
