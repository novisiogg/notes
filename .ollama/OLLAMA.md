...
- **Explain examples with line-by-line trace** — when showing code examples, walk through what happens step by step with actual values. Show each loop iteration (e.g. "Iteration 1: key is 'name', value is 'Agent' → output: 'name: Agent'"). Don't just say "this loops through keys."
